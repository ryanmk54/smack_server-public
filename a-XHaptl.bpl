// generated by SMACK version 1.6.0 for boogie
// via /usr/local/bin/smack /home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c --verifier boogie --mem-mod no-reuse-impls --unroll 80 --loop-limit 120 --context-bound 180 --time-limit 1200 --max-violations 351 --entry-points main --bit-precise --verbose
...
procedure {:inline 80} __SMACK_dummy(v: bv32)
{
$bb0:
  call {:cexpr "v"} boogie_si_record_bv32(v);
...
procedure {:inline 80} __SMACK_code.ref($p0: ref);
procedure {:inline 80} __SMACK_code.ref.bv32($p0: ref, p.1: bv32);
const __VERIFIER_assert: ref;
axiom (__VERIFIER_assert == $sub.ref(0, 68));
procedure {:inline 1} __VERIFIER_assert(x: bv32)
{
$bb0:
  call {:cexpr "x"} boogie_si_record_bv32(x);
  call {:cexpr "v"} boogie_si_record_bv32(x);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 95, 3} true;
  assume true;
...
axiom (__VERIFIER_nondet_int == $sub.ref(0, 76));
procedure {:inline 1} __VERIFIER_nondet_int()
  returns ($r: bv32);
const malloc: ref;
axiom (malloc == $sub.ref(0, 84));
procedure {:inline 80} malloc($i0: bv64)
  returns ($r: ref)
{
  call $r := $alloc($bv2int.64($i0));
}
...
type $mop;
procedure {:inline 80} boogie_si_record_mop(m: $mop);
const $MOP: $mop;
procedure {:inline 80} boogie_si_record_bool(i: bool);
procedure {:inline 80} boogie_si_record_i1(i: i1);
procedure {:inline 80} boogie_si_record_i8(i: i8);
procedure {:inline 80} boogie_si_record_i16(i: i16);
procedure {:inline 80} boogie_si_record_i24(i: i24);
procedure {:inline 80} boogie_si_record_i32(i: i32);
procedure {:inline 80} boogie_si_record_i40(i: i40);
procedure {:inline 80} boogie_si_record_i48(i: i48);
procedure {:inline 80} boogie_si_record_i56(i: i56);
procedure {:inline 80} boogie_si_record_i64(i: i64);
procedure {:inline 80} boogie_si_record_i88(i: i88);
procedure {:inline 80} boogie_si_record_i96(i: i96);
procedure {:inline 80} boogie_si_record_i128(i: i128);
procedure {:inline 80} boogie_si_record_bv1(i: bv1);
procedure {:inline 80} boogie_si_record_bv8(i: bv8);
procedure {:inline 80} boogie_si_record_bv16(i: bv16);
procedure {:inline 80} boogie_si_record_bv24(i: bv24);
procedure {:inline 80} boogie_si_record_bv32(i: bv32);
procedure {:inline 80} boogie_si_record_bv40(i: bv40);
procedure {:inline 80} boogie_si_record_bv48(i: bv48);
procedure {:inline 80} boogie_si_record_bv56(i: bv56);
procedure {:inline 80} boogie_si_record_bv64(i: bv64);
procedure {:inline 80} boogie_si_record_bv88(i: bv88);
procedure {:inline 80} boogie_si_record_bv96(i: bv96);
procedure {:inline 80} boogie_si_record_bv128(i: bv128);
procedure {:inline 80} boogie_si_record_ref(i: ref);
procedure {:inline 80} boogie_si_record_float(i: float);
var $exn: bool;
var $exnv: int;
...
procedure {:inline 80} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 108));
procedure {:inline 80} __SMACK_init_func_memory_model()
{
$bb0:
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1182, 3} true;
  $CurrAddr := $1024.ref;
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1183, 1} true;
  $exn := false;
  return;
}
const create: ref;
axiom (create == $sub.ref(0, 116));
procedure {:inline 80} create(limit: bv32)
  returns ($r: ref)
{
  var $i0: bv1;
  var $i1: bv1;
  ...
  var $p3: ref;
$bb0:
  call {:cexpr "limit"} boogie_si_record_bv32(limit);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 19, 7} true;
  $i0 := $sle.bv32(limit, 0bv32);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 19, 21} true;
  $i1 := $sgt.bv32(limit, 1000bv32);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 19, 7} true;
  $i2 := $or.bv1($i0, $i1);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 19, 7} true;
...
$bb1:
  assume ($i2 == 1bv1);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 19, 40} true;
  $p3 := $0.ref;
  goto $bb3;
$bb2:
  assume !(($i2 == 1bv1));
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 20, 29} true;
  call $p4 := malloc(8bv64);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 20, 18} true;
  $p5 := $bitcast.ref.ref($p4);
  call {:cexpr "acc"} boogie_si_record_ref($p4);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 21, 3} true;
  $p6 := $p5;
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 21, 3} true;
  $M.0 := $store.bytes.bv32($M.0, $p6, 0bv32);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 22, 3} true;
  $p7 := $add.ref($p5, 4);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 22, 3} true;
  $M.0 := $store.bytes.bv32($M.0, $p7, limit);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 23, 3} true;
  $p3 := $p4;
  goto $bb3;
$bb3:
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 24, 1} true;
  $r := $p3;
  $exn := false;
  return;
}
const get_balance: ref;
axiom (get_balance == $sub.ref(0, 124));
procedure {:inline 80} get_balance(acc: ref)
  returns ($r: bv32)
{
  var $p0: ref;
  var $i1: bv32;
$bb0:
  call {:cexpr "acc"} boogie_si_record_ref(acc);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 28, 10} true;
  $p0 := acc;
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 28, 10} true;
  $i1 := $load.bytes.bv32($M.0, $p0);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 28, 3} true;
  $r := $i1;
  $exn := false;
  return;
}
const deposit: ref;
axiom (deposit == $sub.ref(0, 132));
procedure {:inline 80} deposit(acc: ref, n: bv32)
  returns ($r: bv32)
{
  var $i0: bv1;
  var $p2: ref;
...
$bb0:
  call {:cexpr "acc"} boogie_si_record_ref(acc);
  call {:cexpr "n"} boogie_si_record_bv32(n);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 33, 7} true;
  $i0 := $sle.bv32(n, 0bv32);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 33, 7} true;
...
$bb1:
  assume ($i0 == 1bv1);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 33, 15} true;
  $i1 := 0bv32;
  goto $bb3;
$bb2:
  assume !(($i0 == 1bv1));
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 34, 7} true;
  $p2 := acc;
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 34, 7} true;
  $i3 := $load.bytes.bv32($M.0, $p2);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 34, 22} true;
  $p4 := $add.ref(acc, 4);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 34, 22} true;
  ...
  goto $bb4, $bb5;
$bb3:
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 39, 1} true;
  $r := $i1;
  $exn := false;
  return;
$bb4:
  assume ($i7 == 1bv1);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 35, 5} true;
  $i1 := 0bv32;
  goto $bb3;
$bb5:
  assume !(($i7 == 1bv1));
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 37, 18} true;
  $p8 := acc;
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 37, 18} true;
  $i9 := $load.bytes.bv32($M.0, $p8);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 37, 18} true;
  $i10 := $add.bv32($i9, n);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 37, 3} true;
  $p11 := acc;
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 37, 3} true;
  $M.0 := $store.bytes.bv32($M.0, $p11, $i10);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 38, 3} true;
  $i1 := 1bv32;
  goto $bb3;
}
const withdraw: ref;
axiom (withdraw == $sub.ref(0, 140));
procedure {:inline 80} withdraw(acc: ref, n: bv32)
  returns ($r: bv32)
{
  var $i0: bv1;
  var $p2: ref;
...
$bb0:
  call {:cexpr "acc"} boogie_si_record_ref(acc);
  call {:cexpr "n"} boogie_si_record_bv32(n);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 43, 7} true;
  $i0 := $sle.bv32(n, 0bv32);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 43, 7} true;
  assume {:branchcond $i0} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i0 == 1bv1);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 43, 15} true;
  $i1 := 0bv32;
  goto $bb3;
$bb2:
  assume !(($i0 == 1bv1));
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 44, 7} true;
  $p2 := acc;
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 44, 7} true;
  $i3 := $load.bytes.bv32($M.0, $p2);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 44, 7} true;
  ...
  goto $bb4, $bb5;
$bb3:
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 49, 1} true;
  $r := $i1;
  $exn := false;
  return;
$bb4:
  assume ($i4 == 1bv1);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 45, 20} true;
  $p5 := acc;
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 45, 20} true;
  $i6 := $load.bytes.bv32($M.0, $p5);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 45, 20} true;
  $i7 := $sub.bv32($i6, n);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 45, 5} true;
  $p8 := acc;
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 45, 5} true;
  $M.0 := $store.bytes.bv32($M.0, $p8, $i7);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 46, 5} true;
  $i1 := 1bv32;
  goto $bb3;
$bb5:
  assume !(($i4 == 1bv1));
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 48, 3} true;
  $i1 := 0bv32;
  goto $bb3;
}
const test_account: ref;
axiom (test_account == $sub.ref(0, 148));
procedure {:inline 80} test_account(x: bv32, y: bv32, z: bv32)
{
  var $p0: ref;
  var $i1: bv1;
  var $i2: bv32;
...
$bb0:
  call {:cexpr "x"} boogie_si_record_bv32(x);
  call {:cexpr "y"} boogie_si_record_bv32(y);
  call {:cexpr "z"} boogie_si_record_bv32(z);
  call {:cexpr "ops"} boogie_si_record_bv32(0bv32);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 56, 9} true;
  call $p0 := create(x);
  call {:cexpr "acc"} boogie_si_record_ref($p0);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 57, 7} true;
  $i1 := $ne.ref($p0, $0.ref);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 57, 7} true;
...
$bb1:
  assume ($i1 == 1bv1);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 61, 10} true;
  call $i2 := deposit($p0, y);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 61, 3} true;
  $i3 := $add.bv32(0bv32, $i2);
  call {:cexpr "ops"} boogie_si_record_bv32($i3);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 62, 3} true;
  call $i4 := get_balance($p0);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 62, 3} true;
  $i5 := $sge.bv32($i4, 0bv32);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 62, 3} true;
  $i6 := 0bv1;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 70, 1} true;
  $exn := false;
  return;
$bb4:
  assume ($i5 == 1bv1);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 62, 3} true;
  call $i7 := get_balance($p0);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 62, 3} true;
  $i8 := $sle.bv32($i7, 1000bv32);
  $i6 := $i8;
  goto $bb6;
$bb5:
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 62, 3} true;
...
$bb6:
  ...
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 63, 10} true;
  call $i10 := deposit($p0, z);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 63, 3} true;
  $i11 := $add.bv32($i3, $i10);
  call {:cexpr "ops"} boogie_si_record_bv32($i11);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 64, 3} true;
  call $i12 := get_balance($p0);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 64, 3} true;
...
$bb7:
  assume ($i13 == 1bv1);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 64, 3} true;
  call $i15 := get_balance($p0);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 64, 3} true;
  $i16 := $sle.bv32($i15, 1000bv32);
  $i14 := $i16;
  goto $bb9;
$bb8:
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 64, 3} true;
...
$bb9:
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 64, 3} true;
  $i17 := $zext.bv1.bv32($i14);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 64, 3} true;
  call __VERIFIER_assert($i17);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 65, 10} true;
  call $i18 := withdraw($p0, z);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 65, 3} true;
  $i19 := $add.bv32($i11, $i18);
  call {:cexpr "ops"} boogie_si_record_bv32($i19);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 66, 3} true;
  call $i20 := get_balance($p0);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 66, 3} true;
  $i21 := $sge.bv32($i20, 0bv32);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 66, 3} true;
  $i22 := 0bv1;
...
$bb10:
  assume ($i21 == 1bv1);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 66, 3} true;
  call $i23 := get_balance($p0);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 66, 3} true;
  $i24 := $sle.bv32($i23, 1000bv32);
  $i22 := $i24;
  goto $bb12;
$bb11:
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 66, 3} true;
...
$bb12:
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 66, 3} true;
  $i25 := $zext.bv1.bv32($i22);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 66, 3} true;
  call __VERIFIER_assert($i25);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 67, 3} true;
  $i26 := $slt.bv32($i19, 3bv32);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 67, 3} true;
  $i27 := 1bv1;
...
$bb14:
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 67, 3} true;
  $i30 := $zext.bv1.bv32($i27);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 67, 3} true;
  call __VERIFIER_assert($i30);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 68, 8} true;
  $p31 := $bitcast.ref.ref($p0);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 68, 3} true;
  call free_($p31);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 69, 3} true;
  goto $bb3;
$bb15:
  assume !(($i26 == 1bv1));
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 67, 3} true;
  call $i28 := get_balance($p0);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 67, 3} true;
  $i29 := $eq.bv32($i28, y);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 67, 3} true;
  $i27 := $i29;
...
const free_: ref;
axiom (free_ == $sub.ref(0, 156));
procedure {:inline 80} free_($p0: ref)
{
  call $free($p0);
}
const main: ref;
...
$bb0:
  call $initialize();
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 73, 11} true;
  call $i0 := __VERIFIER_nondet_int();
  call {:cexpr "x"} boogie_si_record_bv32($i0);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 74, 11} true;
  call $i1 := __VERIFIER_nondet_int();
  call {:cexpr "y"} boogie_si_record_bv32($i1);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 75, 11} true;
  call $i2 := __VERIFIER_nondet_int();
  call {:cexpr "z"} boogie_si_record_bv32($i2);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 78, 3} true;
  call test_account($i0, $i1, $i2);
  assume {:sourceloc "/home/ubuntu/src/smack_server/public/system/projects/980191294/simple.c", 79, 3} true;
  $r := 0bv32;
  $exn := false;
  return;
}
...
procedure {:inline 80} llvm.dbg.value($p0: ref, $i1: bv64, $p2: ref, $p3: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 180));
procedure {:inline 80} __SMACK_static_init()
{
$bb0:
  $exn := false;
  return;
}
procedure {:inline 80} $initialize()
{
